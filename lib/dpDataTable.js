...
class DpDataTable extends Component {
  ...
  render() {
    const {hidePagination, showFilter, isLoading, iconClasses, items} = this.props;
  ...
  _renderFilter() {
    ...
    return (<div className="form-group col-xs-12 col-sm-6 col-md-4">
      ...
      <div className="input-group">
        ...
        <input type="text" className="form-control" id="exampleInputAmount" placeholder="Filter"
  ...
  _onItemsChange(options) {
    ...
    onItemsChange && onItemsChange(extend({}, this.state, options));
  }
}
