    ...
    return (<nav className={paginationClass}>
      <ul className="pagination pull-right">
        <li className={classNames({'disabled': previousPage === undefined})}><a
          onClick={() => this._onPageClick(previousPage)}><i className="glyphicon glyphicon-backward"></i></a></li>
        <li className={classNames({'disabled': nextPage === undefined})}><a
          onClick={() => this._onPageClick(nextPage)}><i className="glyphicon glyphicon-forward"></i></a></li>
      </ul>
    </nav>);
  }
